        ...
        <template #item="{ element, index: ind }">
          <div class="draggable-itemElement">
            ...
            >
              ...
              ></side-bar>
              <Button
                @click="deleteChildItem(internalValue.column3, ind + 1)"
                text
                severity="danger"
                rounded
                size="small"
        ...
        <template #item="{ element, index: ind }">
          <div class="draggable-itemElement">
            ...
            >
              ...
              ></side-bar>
              <Button
                @click="deleteChildItem(internalValue.column4, ind + 1)"
                text
                severity="danger"
                rounded
                size="small"
